...
from extract_from_apteka_ru import extract_sales_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_apteka_ru_sale',
...
def wf_xls_kafka_mart_fpc_apteka_ru_sale():
    ...
    def extract_from_xls(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(extract_sales_xls,
...
wf_xls_kafka_mart_fpc_apteka_ru_sale()