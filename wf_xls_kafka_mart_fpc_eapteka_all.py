...
from extract_from_eapteka import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_eapteka_all',
...
def wf_xls_kafka_mart_fpc_eapteka_all():
...
wf_xls_kafka_mart_fpc_eapteka_all()