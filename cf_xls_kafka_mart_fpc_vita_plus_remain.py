...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_vita_plus_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Вита Плюс/Остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Вита плюс',
              'prefix_topic': 'fpc_vita_plus'
            },
    tags=['advanced', 'vita_plus']
)
def cf_xls_kafka_mart_fpc_vita_plus_remain():
    @task
...
cf_xls_kafka_mart_fpc_vita_plus_remain()