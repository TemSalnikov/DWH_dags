...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_eapteka_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/ЕАптека/закуп+продажи+ остатки/',
              'name_report': 'Закуп_Остатки_Продажи',
              'name_pharm_chain': 'Еаптека',
              'prefix_topic': 'fpc_eapteka'
            },
    tags=['advanced', 'eapteka']
)
def cf_xls_kafka_mart_fpc_eapteka_all():
    @task
...
cf_xls_kafka_mart_fpc_eapteka_all()