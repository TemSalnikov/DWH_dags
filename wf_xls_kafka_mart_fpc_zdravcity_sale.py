...
from extract_from_zdravcity import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_zdravcity_sale',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'zdravcity']
)

def wf_xls_kafka_mart_fpc_zdravcity_sale():
...
wf_xls_kafka_mart_fpc_zdravcity_sale()