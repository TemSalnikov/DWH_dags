...
from extract_from_fialka import extract_fialka
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_fialka_all',
...
def wf_xls_kafka_mart_fpc_fialka_all():
    ...
    def extract_from_xls_task(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(extract_fialka,
...
wf_xls_kafka_mart_fpc_fialka_all()