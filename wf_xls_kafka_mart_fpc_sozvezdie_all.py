...
from extract_from_sozvezdie import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_sozvezdie_all',
...
def wf_xls_kafka_mart_fpc_sozvezdie_all():
...
wf_xls_kafka_mart_fpc_sozvezdie_all()