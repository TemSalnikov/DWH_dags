...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_vash_doctor_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Ваш доктор/Остатки/',
              'name_report': 'Остатки',
...
def cf_xls_kafka_mart_fpc_vash_doctor_remain():
    @task
