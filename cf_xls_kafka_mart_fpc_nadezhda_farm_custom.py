...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_nadezhda_farm_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Надежда Фарм/Закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_nadezhda_farm_custom():
    @task
...
cf_xls_kafka_mart_fpc_nadezhda_farm_custom()