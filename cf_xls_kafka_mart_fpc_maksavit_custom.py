...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_maksavit_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Максавит/Закупки/',
              'name_report': 'Закупки',
              'name_pharm_chain': 'Максавит',
              'prefix_topic': 'fpc_maksavit'
            },
    tags=['advanced', 'maksavit']
)
def cf_xls_kafka_mart_fpc_maksavit_custom():
    @task
...
cf_xls_kafka_mart_fpc_maksavit_custom()