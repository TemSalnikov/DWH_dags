...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_pharmaimpex_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Фармаимпекс/Закуп_Продажи_Остатки/',
              'name_report': 'Закуп_Продажи_Остатки',
              'name_pharm_chain': 'Фармаимпекс',
              'prefix_topic': 'fpc_pharmaimpex'
            },
    tags=['advanced', 'pharmaimpex']
)
def cf_xls_kafka_mart_fpc_pharmaimpex_all():
    @task
...
cf_xls_kafka_mart_fpc_pharmaimpex_all()