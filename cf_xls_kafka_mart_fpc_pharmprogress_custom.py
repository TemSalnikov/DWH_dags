...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_pharmprogress_custom',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/ФармПрогресс/Закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_pharmprogress_custom():
    @task
...
cf_xls_kafka_mart_fpc_pharmprogress_custom()