...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_nadezhda_farm_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Надежда Фарм/Остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Надежда Фарм',
              'prefix_topic': 'fpc_nadezhda_farm'
            },
    tags=['advanced', 'nadezhda_farm']
)
def cf_xls_kafka_mart_fpc_nadezhda_farm_remain():
    @task
...
cf_xls_kafka_mart_fpc_nadezhda_farm_remain()