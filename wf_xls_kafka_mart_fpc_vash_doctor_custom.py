...
from extract_from_vash_doctor import extract_all_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_vash_doctor_custom',
...
def wf_xls_kafka_mart_fpc_vash_doctor_custom():
    ...
    def extract_from_xls(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(extract_all_xls,
...
wf_xls_kafka_mart_fpc_vash_doctor_custom()