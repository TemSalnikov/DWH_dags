...
from extract_from_social_pharmacy import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_social_pharmacy_all',
...
def wf_xls_kafka_mart_fpc_social_pharmacy_all():
...
wf_xls_kafka_mart_fpc_social_pharmacy_all()