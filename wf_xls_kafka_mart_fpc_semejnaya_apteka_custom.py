...
from extract_from_semejnaya_apteka import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_semejnaya_apteka_custom',
...
def wf_xls_kafka_mart_fpc_semejnaya_apteka_custom():
...
wf_xls_kafka_mart_fpc_semejnaya_apteka_custom()