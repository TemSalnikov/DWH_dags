...
def transform_xl_to_json (path = '',sheet_name = 'Sheet1' , name_report = 'Продужи', name_pharm_chain = '36,6') -> dict:
    ...
    try:
        ...
        df_report = df[['uuid_report', 'Период', 'Количество, уп','Сумма ЗЦ, руб. без НДС', 'hash_drugstore', 'hash_drugstore_addr', 'hash_product']]
