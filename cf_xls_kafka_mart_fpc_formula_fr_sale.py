...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_formula_fr_sale',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Формула ФР/Продажи/',
              'name_report': 'Продажи',
              'name_pharm_chain': 'Формула ФР',
              'prefix_topic': 'fpc_formula_fr'
            },
    tags=['formula_fr', 'sales']
)
def cf_xls_kafka_mart_fpc_formula_fr_sale():
    @task
...
cf_xls_kafka_mart_fpc_formula_fr_sale()