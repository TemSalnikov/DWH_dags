...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_garmoniya_zdorovya_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Гармония здоровья/Закупки, продажи, остатки/',
              'name_report': 'Закуп_Продажи_Остатки',
              'name_pharm_chain': 'Гармония здоровья',
              'prefix_topic': 'fpc_garmoniya_zdorovya'
            },
    tags=['advanced', 'garmoniya_zdorovya']
)
def cf_xls_kafka_mart_fpc_garmoniya_zdorovya_all():
    @task
...
cf_xls_kafka_mart_fpc_garmoniya_zdorovya_all()