...
from extract_from_pharmprogress import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_pharmprogress_remain',
...
def wf_xls_kafka_mart_fpc_pharmprogress_remain():
...
wf_xls_kafka_mart_fpc_pharmprogress_remain()