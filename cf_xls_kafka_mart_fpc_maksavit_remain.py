...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_maksavit_remain',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Максавит/Остатки/',
              'name_report': 'Остатки',
...
def cf_xls_kafka_mart_fpc_maksavit_remain():
    @task
...
cf_xls_kafka_mart_fpc_maksavit_remain()