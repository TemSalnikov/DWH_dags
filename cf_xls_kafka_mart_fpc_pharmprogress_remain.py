...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_pharmprogress_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/ФармПрогресс/Остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Фармпрогресс',
              'prefix_topic': 'fpc_pharmprogress'
            },
    tags=['advanced', 'pharmprogress']
)
def cf_xls_kafka_mart_fpc_pharmprogress_remain():
    @task
...
cf_xls_kafka_mart_fpc_pharmprogress_remain()