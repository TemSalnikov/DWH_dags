...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_mz_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/МЗ/Закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_mz_custom():
    @task
    ...
    def trigger_or_skip(parametrs: Optional[Dict], processing_files: Optional[Dict], **context):
        ...
        if processing_files:
            ...
            TriggerDagRunOperator(
                task_id=f"trigger_wf_mz_custom",
                trigger_dag_id='wf_xls_kafka_mart_fpc_mz_custom',
...
cf_xls_kafka_mart_fpc_mz_custom()