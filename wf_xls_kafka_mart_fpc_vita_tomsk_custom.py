...
from extract_from_vita_tomsk import extract_custom
...
@dag(
    dag_id='wf_xls_kafka_mart_fpc_vita_tomsk_custom',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'vita_tomsk']
)
def wf_xls_kafka_mart_fpc_vita_tomsk_custom():
...
wf_xls_kafka_mart_fpc_vita_tomsk_custom()