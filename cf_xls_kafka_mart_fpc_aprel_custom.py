...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_aprel_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Апрель/Закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_aprel_custom():
    @task
...
cf_xls_kafka_mart_fpc_aprel_custom()