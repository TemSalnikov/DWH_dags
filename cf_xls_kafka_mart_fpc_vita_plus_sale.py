...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_vita_plus_sale',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Вита Плюс/Продажи/',
              'name_report': 'Продажи',
...
def cf_xls_kafka_mart_fpc_vita_plus_sale():
    @task
...
cf_xls_kafka_mart_fpc_vita_plus_sale()