...
from extract_from_erkafarm import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_erkafarm_custom',
...
def wf_xls_kafka_mart_fpc_erkafarm_custom():
...
wf_xls_kafka_mart_fpc_erkafarm_custom()