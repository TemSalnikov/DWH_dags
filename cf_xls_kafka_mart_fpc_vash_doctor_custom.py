...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_vash_doctor_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Ваш доктор/Закупки/',
              'name_report': 'Закупки',
              'name_pharm_chain': 'Ваш доктор',
              'prefix_topic': 'fpc_vash_doctor'
...
def cf_xls_kafka_mart_fpc_vash_doctor_custom():
    @task
...
cf_xls_kafka_mart_fpc_vash_doctor_custom()