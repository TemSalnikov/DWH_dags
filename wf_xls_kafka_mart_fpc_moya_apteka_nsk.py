...
from extract_from_moya_apteka_NSK import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_moya_apteka_nsk',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'moya_apteka_nsk']
)

def wf_xls_kafka_mart_fpc_moya_apteka_nsk():
...
wf_xls_kafka_mart_fpc_moya_apteka_nsk()