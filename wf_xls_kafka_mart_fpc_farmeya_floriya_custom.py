...
from extract_from_farmeya_floriya import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_farmeya_floriya_custom',
...
def wf_xls_kafka_mart_fpc_farmeya_floriya_custom():
...
wf_xls_kafka_mart_fpc_farmeya_floriya_custom()