...
from extract_from_neo_pharm import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_neo_pharm_custom',
...
def wf_xls_kafka_mart_fpc_neo_pharm_custom():
...
wf_xls_kafka_mart_fpc_neo_pharm_custom()