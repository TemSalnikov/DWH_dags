...
from extract_from_farmland import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_farmland_custom',
...
def wf_xls_kafka_mart_fpc_farmland_custom():
...
wf_xls_kafka_mart_fpc_farmland_custom()