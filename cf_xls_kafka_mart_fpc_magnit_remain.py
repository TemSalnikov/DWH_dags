...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_magnit_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Магнит/остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Магнит',
              'prefix_topic': 'fpc_magnit'
            },
    tags=['advanced', 'magnit']
)
def cf_xls_kafka_mart_fpc_magnit_remain():
    @task
...
cf_xls_kafka_mart_fpc_magnit_remain()