...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_neo_pharm_remain',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Нео-Фарм/Остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Нео фарм',
              'prefix_topic': 'fpc_neo_pharm'
            },
    tags=['advanced', 'neo_pharm']
)
def cf_xls_kafka_mart_fpc_neo_pharm_remain():
    @task
...
cf_xls_kafka_mart_fpc_neo_pharm_remain()