...
from extract_from_iris import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_iris_custom',
...
def wf_xls_kafka_mart_fpc_iris_custom():
...
wf_xls_kafka_mart_fpc_iris_custom()