...
from extract_from_farmpomosch_biysk import extract_xls
...
@dag(
    dag_id='wf_xls_kafka_mart_fpc_farmpomosch_biysk_sales_remains',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['farmpomosch_biysk', 'sales', 'remains', 'advanced']
)

def wf_xls_kafka_mart_fpc_farmpomosch_biysk_sales_remains():
...
wf_xls_kafka_mart_fpc_farmpomosch_biysk_sales_remains()