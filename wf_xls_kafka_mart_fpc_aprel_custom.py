...
from extract_from_aprel import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_aprel_custom',
...
def wf_xls_kafka_mart_fpc_aprel_custom():
...
wf_xls_kafka_mart_fpc_aprel_custom()