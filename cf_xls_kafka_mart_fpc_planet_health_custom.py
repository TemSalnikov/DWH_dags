...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_planet_health_custom',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Планета Здоровья/закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_planet_health_custom():
    @task
...
cf_xls_kafka_mart_fpc_planet_health_custom()