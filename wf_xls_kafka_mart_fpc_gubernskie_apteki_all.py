...
from extract_from_gubernskie_apteki import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_gubernskie_apteki_all',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'gubernskie_apteki']
)

def wf_xls_kafka_mart_fpc_gubernskie_apteki_all():
...
wf_xls_kafka_mart_fpc_gubernskie_apteki_all()