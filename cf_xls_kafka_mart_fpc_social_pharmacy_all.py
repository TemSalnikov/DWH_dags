...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_social_pharmacy_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Социальная аптка/Остатки_Закуп_Продажи/',
              'name_report': 'Остатки_Закуп_Продажи',
              'name_pharm_chain': 'Социальная аптека',
              'prefix_topic': 'fpc_social_pharmacy'
            },
    tags=['advanced', 'social_pharmacy']
)
def cf_xls_kafka_mart_fpc_social_pharmacy_all():
    @task
...
cf_xls_kafka_mart_fpc_social_pharmacy_all()