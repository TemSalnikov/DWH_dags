...
from extract_from_unipharm import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_unipharm_custom',
...
def wf_xls_kafka_mart_fpc_unipharm_custom():
...
wf_xls_kafka_mart_fpc_unipharm_custom()