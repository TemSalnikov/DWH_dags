...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_zhivika_sale',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/Живика/продажи/',
              'name_report': 'Продажи',
...
def cf_xls_kafka_mart_fpc_zhivika_sale():
    @task
...
cf_xls_kafka_mart_fpc_zhivika_sale()