...
from extract_from_magnit import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_magnit_custom',
...
def wf_xls_kafka_mart_fpc_magnit_custom():
...
wf_xls_kafka_mart_fpc_magnit_custom()