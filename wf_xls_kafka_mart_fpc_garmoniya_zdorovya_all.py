...
from extract_from_garmoniya_zdorovya import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_garmoniya_zdorovya_all',
...
def wf_xls_kafka_mart_fpc_garmoniya_zdorovya_all():
...
wf_xls_kafka_mart_fpc_garmoniya_zdorovya_all()