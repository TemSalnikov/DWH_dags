...
from extract_from_formula_fr import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_formula_fr_remain',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['formula_fr', 'remains']
)

def wf_xls_kafka_mart_fpc_formula_fr_remain():
...
wf_xls_kafka_mart_fpc_formula_fr_remain()