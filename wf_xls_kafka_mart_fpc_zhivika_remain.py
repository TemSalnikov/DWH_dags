...
from extract_from_zhivika import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_zhivika_remain',
...
def wf_xls_kafka_mart_fpc_zhivika_remain():
...
wf_xls_kafka_mart_fpc_zhivika_remain()