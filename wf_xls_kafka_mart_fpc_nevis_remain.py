...
from extract_from_nevis import extract_nevis
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_nevis_remain',
...
def wf_xls_kafka_mart_fpc_nevis_remain():
    ...
    def extract_from_xls(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(extract_nevis,
...
wf_xls_kafka_mart_fpc_nevis_remain()