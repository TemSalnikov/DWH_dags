...
from extract_from_zdraviya import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_zdraviya_all',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'zdraviya']
)

def wf_xls_kafka_mart_fpc_zdraviya_all():
...
wf_xls_kafka_mart_fpc_zdraviya_all()