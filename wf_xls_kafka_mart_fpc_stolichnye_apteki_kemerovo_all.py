...
from extract_from_stolichnye_apteki_kemerovo import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_stolichnye_apteki_kemerovo_all',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'stolichnye_apteki_kemerovo']
)

def wf_xls_kafka_mart_fpc_stolichnye_apteki_kemerovo_all():
...
wf_xls_kafka_mart_fpc_stolichnye_apteki_kemerovo_all()