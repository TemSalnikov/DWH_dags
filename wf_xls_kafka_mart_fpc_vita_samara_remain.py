...
from extract_from_vita_samara import _extract_sales_or_remains
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_vita_samara_remain',
...
def wf_xls_kafka_mart_fpc_vita_samara_remain():
    ...
    def extract_from_xls(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(_extract_sales_or_remains,
...
wf_xls_kafka_mart_fpc_vita_samara_remain()
