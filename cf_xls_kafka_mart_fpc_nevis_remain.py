...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_nevis_remain',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Невис/Остатки/',
              'name_report': 'Остатки',
              'name_pharm_chain': 'Невис',
              'prefix_topic': 'fpc_nevis'
            },
    tags=['advanced', 'nevis']
)
def cf_xls_kafka_mart_fpc_nevis_remain():
    @task
...
cf_xls_kafka_mart_fpc_nevis_remain()