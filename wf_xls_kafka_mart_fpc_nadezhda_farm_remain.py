...
from extract_from_nadezhda_farm import extract_nadezhda_farm
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_nadezhda_farm_remain',
...
def wf_xls_kafka_mart_fpc_nadezhda_farm_remain():
    ...
    def extract_from_xls(configs:dict, **context):
        ...
        for folder, files in configs[algo_id]['files'].items():
            for file in files:
                ...
                if call_producer(extract_nadezhda_farm,
...
wf_xls_kafka_mart_fpc_nadezhda_farm_remain()