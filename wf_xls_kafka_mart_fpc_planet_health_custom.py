...
from extract_from_planet_health import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_planet_health_custom',
...
def wf_xls_kafka_mart_fpc_planet_health_custom():
...
wf_xls_kafka_mart_fpc_planet_health_custom()