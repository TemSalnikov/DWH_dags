...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_magnit_custom',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Магнит/закуп/',
              'name_report': 'Закупки',
...
def cf_xls_kafka_mart_fpc_magnit_custom():
    @task
...
cf_xls_kafka_mart_fpc_magnit_custom()