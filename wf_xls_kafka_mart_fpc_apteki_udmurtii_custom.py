...
from extract_from_apteki_udmurtii import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_apteki_udmurtii_custom',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'apteki_udmurtii']
)

def wf_xls_kafka_mart_fpc_apteki_udmurtii_custom():
...
wf_xls_kafka_mart_fpc_apteki_udmurtii_custom()