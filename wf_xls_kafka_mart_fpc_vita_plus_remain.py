...
from extract_from_vita_plus import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_vita_plus_remain',
...
def wf_xls_kafka_mart_fpc_vita_plus_remain():
...
wf_xls_kafka_mart_fpc_vita_plus_remain()