...
from extract_from_pharmaimpex import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_pharmaimpex_all',
...
def wf_xls_kafka_mart_fpc_pharmaimpex_all():
...
wf_xls_kafka_mart_fpc_pharmaimpex_all()