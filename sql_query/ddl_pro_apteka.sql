--drop table stg.mart_fpc_pro_apteka_report

create table stg.mart_fpc_pro_apteka_report
(
	uuid_report text,
	inn text,
...
--drop table kafka.fpc_pro_apteka_report

create table kafka.fpc_pro_apteka_report
(
	uuid_report text,
	inn text,
	contractor_name text,
...
--drop VIEW kafka.fpc_pro_apteka_report_mv

CREATE MATERIALIZED VIEW kafka.fpc_pro_apteka_report_mv  TO stg.mart_fpc_pro_apteka_report AS 
