--drop table stg.mart_fpc_erkafarm_report

create table stg.mart_fpc_erkafarm_report
(
    uuid_report text,
    product_name text,
    pharmacy_name text,
...
--drop table kafka.fpc_erkafarm_report

create table kafka.fpc_erkafarm_report
(
    uuid_report text,
    product_name text,
    pharmacy_name text,
...
--drop VIEW kafka.fpc_erkafarm_report_mv

CREATE MATERIALIZED VIEW kafka.fpc_erkafarm_report_mv  TO stg.mart_fpc_erkafarm_report AS 
