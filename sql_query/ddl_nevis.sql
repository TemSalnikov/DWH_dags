--drop table stg.mart_fpc_nevis_report

create table stg.mart_fpc_nevis_report
(
	uuid_report text,
	product_code text,
	product_name text,
...
--drop table kafka.fpc_nevis_report

create table kafka.fpc_nevis_report
(
	uuid_report text,
	product_code text,
	product_name text,
...
--drop VIEW kafka.fpc_nevis_report_mv

CREATE MATERIALIZED VIEW kafka.fpc_nevis_report_mv  TO stg.mart_fpc_nevis_report AS 
