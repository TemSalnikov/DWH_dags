...
create table stg.mart_fpc_25_report
(
	uuid_report text,
	product text,
	start_quantity text,
...
--drop table kafka.fpc_25_report

create table kafka.fpc_25_report
(
	uuid_report text,
	product text,
	start_quantity text,
...
CREATE MATERIALIZED VIEW kafka.fpc_25_report_mv  TO stg.mart_fpc_25_report AS 
