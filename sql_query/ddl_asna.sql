--drop table stg.mart_fpc_asna_report on cluster cluster_2S_2R

create table stg.mart_fpc_asna_report on cluster cluster_2S_2R
(
    uuid_report text,
    legal_entity text,
    inn text,
...
--drop table kafka.fpc_asna_report on cluster cluster_2S_2R

create table kafka.fpc_asna_report on cluster cluster_2S_2R
(
    uuid_report text,
    legal_entity text,
    inn text,
...
--drop VIEW kafka.fpc_asna_report_mv on cluster cluster_2S_2R

CREATE MATERIALIZED VIEW kafka.fpc_asna_report_mv  on cluster cluster_2S_2R TO stg.mart_fpc_asna_report AS 
