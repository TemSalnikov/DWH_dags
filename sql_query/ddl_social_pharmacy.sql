--drop table stg.mart_fpc_social_pharmacy_report

create table stg.mart_fpc_social_pharmacy_report
(
	uuid_report text,
...
--drop table kafka.fpc_social_pharmacy_report

create table kafka.fpc_social_pharmacy_report
(
	uuid_report text,
	subcontract_name text,
	product_name text,
...
--drop VIEW kafka.fpc_social_pharmacy_report_mv

CREATE MATERIALIZED VIEW kafka.fpc_social_pharmacy_report_mv  TO stg.mart_fpc_social_pharmacy_report AS 
