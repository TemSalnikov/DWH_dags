...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_fialka_all',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Фиалка/Закуп Продажи Остатки/',
              'name_report': 'Закуп_Продажи_Остатки',
              'name_pharm_chain': 'Фиалка',
              'prefix_topic': 'fpc_fialka'
            },
    tags=['advanced', 'fialka']
)
def cf_xls_kafka_mart_fpc_fialka_all():
    @task
...
cf_xls_kafka_mart_fpc_fialka_all()