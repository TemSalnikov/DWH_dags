...
from extract_from_pro_apteka import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_pro_apteka_all',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    tags=['advanced', 'pro_apteka']
)

def wf_xls_kafka_mart_fpc_pro_apteka_all():
...
wf_xls_kafka_mart_fpc_pro_apteka_all()