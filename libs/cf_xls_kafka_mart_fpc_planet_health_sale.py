...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_planet_health_sale',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Планета Здоровья/продажи+ остатки/',
              'name_report': 'Продажи',
              'name_pharm_chain': 'Планета Здоровья',
              'prefix_topic': 'fpc_planet_health'
            },
    tags=['advanced', 'planet_health']
)
def cf_xls_kafka_mart_fpc_planet_health_sale():
    @task
...
cf_xls_kafka_mart_fpc_planet_health_sale()