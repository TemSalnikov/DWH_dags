...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_apteka_ru_sale',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Аптека_Ру/Продажи/',
              'name_report': 'Продажи',
              'name_pharm_chain': 'Аптека_ру',
              'prefix_topic': 'fpc_apteka_ru'
            },
    tags=['advanced', 'apteka_ru']
)
def cf_xls_kafka_mart_fpc_apteka_ru_sale():
    @task
...
cf_xls_kafka_mart_fpc_apteka_ru_sale()