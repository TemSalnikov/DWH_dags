...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_sozvezdie_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Созвездие/Закуп Продажи Остатки/',
              'name_report': 'Закуп_Продажи_Остатки',
              'name_pharm_chain': 'Созвездие',
              'prefix_topic': 'fpc_sozvezdie'
            },
    tags=['advanced', 'sozvezdie']
)
def cf_xls_kafka_mart_fpc_sozvezdie_all():
    @task
...
cf_xls_kafka_mart_fpc_sozvezdie_all()