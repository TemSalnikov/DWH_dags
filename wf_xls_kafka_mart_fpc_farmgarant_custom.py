...
from extract_from_farmgarant import extract_xls
...
@dag(
    dag_id = 'wf_xls_kafka_mart_fpc_farmgarant_custom',
...
def wf_xls_kafka_mart_fpc_farmgarant_custom():
...
wf_xls_kafka_mart_fpc_farmgarant_custom()