...
@dag(
    dag_id='cf_xls_kafka_mart_fpc_aloe_all',
    default_args=default_args,
    schedule_interval="@monthly",
    catchup=False,
    params = {'directory': '/opt/airflow/data/reports/Алоэ/Закуп_Продажи_Остатки/',
              'name_report': 'Закуп_Продажи_Остатки',
              'name_pharm_chain': 'Алоэ',
              'prefix_topic': 'fpc_aloe'
...
def cf_xls_kafka_mart_fpc_aloe_all():
    @task
...
cf_xls_kafka_mart_fpc_aloe_all()
